    ...
    return (
        <div id="projects_page">
            ...
            <ul className="block list-disc m-4 mx-0 pl-10">
                ...
                <li><p style={{ display: 'inline' }}><span className="font-bold">Case Study on Twitter Fleets</span> -- This was my first foray into product management/prototyping as part of the first Product Buds Fellowship. I, along with Drithi Iyer and Sumegha Aryal, made a 27 page pitch deck on how Fleets could have been improved. </p>[<a id="twitter-link" className="text-blue-700 focus:text-purple-900 focus:outline-none underline" href="https://docs.google.com/presentation/d/1CEWb3mwOMln45hiXBhtQoC2js33JywQL/edit?usp=sharing&ouid=101262000765985839539&rtpof=true&sd=true" target="_blank">Link</a>]
                </li>
                ...
                code
                https://github.com/stevetng/react_practice
            </ul>
        </div>
    )
}